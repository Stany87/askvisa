...
if (!class_exists('InvoicePDF')) {
    class InvoicePDF extends TCPDF {
        ...
        public function Header() {
            ...
            $this->Cell(0, 5, 'Shop No 16, 2nd Floor, VED TransCube Plaza K. J, Indubhai Patel Marg,', 0, 1, 'C');
            $this->Cell(0, 5, 'opposite the Main Railway Station, MS University, Sayajiganj, Vadodara, Gujarat 390007', 0, 1, 'C');
            $this->Cell(0, 5, 'Email: info@askvisa.in | Phone: +91 7880789486', 0, 1, 'C');
        ...
        public function Footer() {
            ...
            $this->Ln(4);
            $this->Cell(0, 10, 'For any queries, contact: info@askvisa.in', 0, 0, 'C');
        }
    }
}
