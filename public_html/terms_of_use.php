...
<head>
    ...
    <title>Terms of Use - FlyAnyTrip</title>
...
<body>
    ...
    <div class="container">
        ...
        <p>Welcome to FlyAnyTrip! By accessing or using our website, services, and tools, you agree to comply with and be bound by the following terms and conditions. Please read them carefully.</p>
        ...
        <p>FlyAnyTrip provides visa processing assistance, travel documentation support, and related services. We act as an intermediary between you and relevant government authorities. We do not guarantee visa approval, as the final decision lies with the respective government bodies.</p>
        ...
        <p>FlyAnyTrip shall not be liable for any indirect, incidental, special, or consequential damages resulting from your use of our services. We are not responsible for delays, rejections, or any other actions taken by government authorities/embassies.</p>
        <p>In no event shall our total liability exceed the amount of service fees paid by you to us.</p>

        <h2>6. Intellectual Property</h2>
        <p>All content on this website, including text, graphics, logos, and software, is the property of FlyAnyTrip and is protected by copyright laws. You may not reproduce, distribute, or create derivative works without our express written permission.</p>
