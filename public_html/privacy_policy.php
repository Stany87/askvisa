...
<head>
    ...
    <title>Privacy Policy - FlyAnyTrip</title>
...
<body>
    ...
    <nav>
        <a href="landing.php" class="logo">
            <img src="assets/logo-new-5.png" alt="FlyAnyTrip Logo">
        </a>
        <div class="nav-links">
    ...
    <div class="container">
        ...
        <p>This Privacy Policy describes how <strong>FLYANYTRIP</strong> and its affiliates (collectively "FLYANYTRIP, we, our, us") collect, use, share, protect or otherwise process your information/ personal data through our website https://www.flyanytrip.com (hereinafter referred to as Platform). Please note that you may be able to browse certain sections of the Platform without registering with us. We do not offer any product/service under this Platform outside India and your personal data will primarily be stored and processed in India. By visiting this Platform, providing your information or availing any product/service offered on the Platform, you expressly agree to be bound by the terms and conditions of this Privacy Policy, the Terms of Use and the applicable service/product terms and conditions, and agree to be governed by the laws of India including but not limited to the laws applicable to data protection and privacy. If you do not agree please do not use or access our Platform.</p>
        ...
        <p>If you receive an email, a call from a person/association claiming to be FLYANYTRIP seeking any personal data like debit/credit card PIN, net-banking or mobile banking password, we request you to never provide such information. If you have already revealed such information, report it immediately to an appropriate law enforcement agency.</p>
        ...
        <p>At FLYANYTRIP, we strive to provide the best visa application services. Detailed below is our refund and cancellation policy:</p>
        <ul>
            <li><strong>Service Fees:</strong> The service fees charged by FLYANYTRIP for processing your visa application are non-refundable once the application process has been initiated or the application has been submitted to the respective Embassy/Consulate/Government Authority.</li>
            ...
            <li><strong>Rejections:</strong> Visa approval is at the sole discretion of the immigration authorities. FLYANYTRIP cannot be held responsible for any rejection, and no refunds will be provided in case of visa refusal.</li>
    ...
    <footer>
        <p>&copy; <?php echo date('Y'); ?> FlyAnyTrip. All rights reserved.</p>
    </footer>
