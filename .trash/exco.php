...
<script>
    ...
    // Function to download summary as PDF - FIXED VERSION
    async function downloadSummaryAsPDF() {
        try {
            ...
            if (window.summaryData && window.summaryData.order_info) {
                    ...
                    <div class="section">
                        ...
                        <div class="info-grid">
                            <div class="info-item">
                                ...
                                <div class="info-value">${window.summaryData.order_info.id || 'N/A'}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Country</div>
                                <div class="info-value">${window.summaryData.country_name || 'N/A'}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Primary Contact Email</div>
                                <div class="info-value">${window.summaryData.order_info.email || 'N/A'}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Primary Contact Phone</div>
                                <div class="info-value">${window.summaryData.order_info.phone || 'N/A'}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Payment Status</div>
                                <div class="info-value ${window.summaryData.order_info.payment_status === 'paid' ? 'status-paid' : 'status-pending'}">
                ...
                if (window.summaryData.order_info.total_amount) {
                    pdfHtml += `
                            <div class="info-item">
                                ...
                                <div class="info-value">${window.summaryData.order_info.currency} ${window.summaryData.order_info.total_amount}</div>
                            </div>
                    `;
                }
                ...
                pdfHtml += `
                            <div class="info-item">
                                ...
                                <div class="info-value">${window.summaryData.order_info.visa_status || 'initiated'}</div>
                            </div>
                        </div>
                    </div>
                `;
                    ...
                    <div class="section">
                        ...
                        <div class="info-grid">
                            <div class="info-item">
                                ...
                                <div class="info-value">${window.summaryData.payment_info.provider_payment_id || 'N/A'}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Payment Provider</div>
                                <div class="info-value">${window.summaryData.payment_info.provider || 'Razorpay'}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Amount Paid</div>
                                <div class="info-value">${window.summaryData.payment_info.currency} ${window.summaryData.payment_info.amount}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Payment Status</div>
                                <div class="info-value">${window.summaryData.payment_info.status ? window.summaryData.payment_info.status.toUpperCase() : 'N/A'}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Payment Date</div>
                                <div class="info-value">${window.summaryData.payment_info.created_at ? new Date(window.summaryData.payment_info.created_at).toLocaleString() : 'N/A'}</div>
                            </div>
                        </div>
                    </div>
                `;
                    ...
                    pdfHtml += `
                        <div class="section">
                            ...
                            <div class="info-grid">
                                ...
                                <div class="info-item">
                                    <div class="info-label">Visa Status</div>
                                    <div class="info-value">${applicant.visa_status || 'submitted'}</div>
                                </div>
                            </div>
                    `;
            ...
            if (!printWindow) {
                ...
                downloadPdfBtn.innerHTML = '<i class="fas fa-download"></i> Download as PDF';
                return;
            }
            ...
            printWindow.onload = function() {
                ...
                html2pdf().set(opt).from(printWindow.document.body).save().then(() => {
                    ...
                    alert('PDF generation failed. You can try printing the page instead.');
                    printWindow.close();
                    downloadPdfBtn.disabled = false;
                    downloadPdfBtn.innerHTML = '<i class="fas fa-download"></i> Download as PDF';
                });
