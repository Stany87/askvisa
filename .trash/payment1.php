            ...
            <div class="application-summary">
                ...
                <div class="summary-grid">
                    <div class="summary-item">
                        ...
                        <div class="summary-value" id="applicationId">VISA_<?php echo time(); ?>_<?php echo rand(1000, 9999); ?></div>
                    </div>
                    ...
                    <div class="summary-item">
                        ...
                        <div class="summary-value" id="countryDisplay">
                            <?php 
                                $countries = ['us' => 'United States', 'uk' => 'United Kingdom', 'fr' => 'France'];
                                echo $countries[$country] ?? 'United States';
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="summary-item">
                        ...
                        <div class="summary-value" id="visaTypeDisplay">Tourist Visa (Single Entry)</div>
                    </div>
                ...
                <div class="total-amount">
                    ...
                    <div class="total-value" id="feeAmount">$185.00</div>
            ...
            <div class="payment-form">
                ...
                <div id="paymentSection">
                    ...
                    <button id="payButton" onclick="processPayment()">
                        <i class="fas fa-lock"></i> Pay $185.00 Now
                    </button>
                    ...
                    <div class="success-screen">
                        ...
                        <div class="success-details">
                            ...
                            <div class="detail-row">
                                ...
                                <span class="detail-value" id="successAmount">$185.00</span>
                            </div>
                            <div class="detail-row">
