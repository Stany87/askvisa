    ...
    async function downloadSummaryAsPDF() {
        try {
            ...
            if (!window.summaryData) {
                const response = await fetch('?get_summary=1');
                window.summaryData = await response.json();
            }
            
            if (!window.summaryData.success) {
            ...
            if (window.summaryData.order_info) {
                pdfHtml += `
                    <div class="section">
                        ...
                        <div class="grid">
                            <div class="item">
                                ...
                                <div class="value">${window.summaryData.order_info.id || 'N/A'}</div>
                            </div>
                            <div class="item">
                                <div class="label">Country</div>
                                <div class="value">${window.summaryData.country_name || 'N/A'}</div>
                            </div>
                            <div class="item">
                                <div class="label">Primary Contact Email</div>
                                <div class="value">${window.summaryData.order_info.email || 'N/A'}</div>
                            </div>
                            <div class="item">
                                <div class="label">Primary Contact Phone</div>
                                <div class="value">${window.summaryData.order_info.phone || 'N/A'}</div>
                            </div>
                            <div class="item">
                                <div class="label">Payment Status</div>
                                <div class="value ${window.summaryData.order_info.payment_status === 'paid' ? 'status-paid' : 'status-pending'}">
                                    ${window.summaryData.order_info.payment_status === 'paid' ? 'PAID' : 'PENDING'}
                                </div>
                            </div>
                            <div class="item">
                                <div class="label">Visa Status</div>
                                <div class="value">${window.summaryData.order_info.visa_status || 'initiated'}</div>
                            </div>
                `;
                ...
                if (window.summaryData.order_info.total_amount) {
                    pdfHtml += `
                            <div class="item">
                                ...
                                <div class="value">${window.summaryData.order_info.currency} ${window.summaryData.order_info.total_amount}</div>
                            </div>
                    `;
                }
            ...
            if (window.summaryData.payment_info) {
                pdfHtml += `
                    <div class="section">
                        ...
                        <div class="grid">
                            <div class="item">
                                ...
                                <div class="value">${window.summaryData.payment_info.provider_payment_id || 'N/A'}</div>
                            </div>
                            <div class="item">
                                <div class="label">Payment Provider</div>
                                <div class="value">${window.summaryData.payment_info.provider || 'Razorpay'}</div>
                            </div>
                            <div class="item">
                                <div class="label">Amount Paid</div>
                                <div class="value">${window.summaryData.payment_info.currency} ${window.summaryData.payment_info.amount}</div>
                            </div>
                            <div class="item">
                                <div class="label">Payment Status</div>
                                <div class="value">${window.summaryData.payment_info.status ? window.summaryData.payment_info.status.toUpperCase() : 'N/A'}</div>
                            </div>
                            <div class="item">
                                <div class="label">Payment Date</div>
                                <div class="value">${window.summaryData.payment_info.created_at ? new Date(window.summaryData.payment_info.created_at).toLocaleString() : 'N/A'}</div>
                            </div>
                        </div>
                    </div>
                `;
                        ...
                        <div class="section">
                            ...
                            <div class="grid">
                                ...
                                <div class="item">
                                    ...
                                    <div class="value">${applicant.phone || 'N/A'}</div>
                                </div>
                                <div class="item">
                                    <div class="label">Visa Status</div>
                                    <div class="value">${applicant.visa_status || 'submitted'}</div>
                                </div>
                            </div>
                    `;
                    ...
                    if (applicant.answers) {
                        ...
                        Object.keys(applicant.answers).forEach(qId => {
                            ...
                            if (answer.includes('fetch_file.php')) {
                                ...
                                pdfHtml += `
                                    <div class="file-item">
                                        <div class="file-icon">${isPdf ? '📄' : '🖼️'}</div>
                                        <div class="file-info">
                                            <div class="file-name">${label}</div>
                                            <div class="file-type">${fileName} • ${isPdf ? 'PDF Document' : 'Image File'}</div>
                                        </div>
                                    </div>
                                `;
                            } else {
            ...
            const element = tempIframe.contentDocument.body;
