...
<script>
    ...
    // // Function to download summary as PDF - USING THE CORRECTED VERSION FROM SECOND CODE
    // async function downloadSummaryAsPDF() {
    //     // Hide the download button
    //     if (downloadPdfBtn) {
    //         downloadPdfBtn.classList.add('hidden');
    ...
    //                         </div>
    //                         <div style="background: #f8f9fa; padding: 10px 12px; border-radius: 6px; border-left: 3px solid #4361ee; font-weight: 500;">
    //                             ${data.order_info.currency || 'INR'} ${data.order_info.total_amount || '0'}
    //                         </div>
    //                     </div>
    //                     <div style="margin-bottom: 10px;">
    //                         <div style="font-size: 12px; color: #666; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 5px;">
    ...
    //                             </div>
    //                             <div style="background: #f8f9fa; padding: 10px 12px; border-radius: 6px; border-left: 3px solid #4361ee; font-weight: 500;">
    //                                 ${data.payment_info.provider || 'Razorpay'}
    //                             </div>
    //                         </div>
    //                         <div style="margin-bottom: 10px;">
    //                             <div style="font-size: 12px; color: #666; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 5px;">
    ...
    //                             </div>
    //                             <div style="background: #f8f9fa; padding: 10px 12px; border-radius: 6px; border-left: 3px solid #4361ee; font-weight: 500;">
    //                                 ${data.payment_info.currency || 'INR'} ${data.payment_info.amount || '0'}
    //                             </div>
    //                         </div>
    //                         <div style="margin-bottom: 10px;">
    //                             <div style="font-size: 12px; color: #666; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 5px;">
